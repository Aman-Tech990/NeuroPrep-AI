    ...
    return (
        <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
            <motion.header
                ...
                className='max-w-7xl mx-auto mt-8 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0px_25px_45px_rgba(0,0,0,0.6)]'
            >
                <h3
            ...
            <main
                className='max-w-7xl mx-auto py-10 grid grid-cols-1 md:grid-cols-2 gap-20 items-center'
            >
                {/* Left Section */}
                <motion.div
                ...
                >
                    <h1
                        className='text-4xl lg:text-5xl font-extrabold leading-tight bg-gradient-to-r from-black/90 via-black/60 to-black/90 bg-clip-text text-transparent'
                    >
                    ...
                    <p
                        className='mt-6 max-w-xl text-lg bg-gradient-to-r from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'
                    >
                    ...
                    >
                        Start with 50 free credits • Ugrade anytime for more credits • Instant access
                    </p>
